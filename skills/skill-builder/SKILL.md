---
name: skill-builder
description: Use when the user wants to build a skill, make a slash command, automate a workflow, or runs /skill-builder. Guides skill development following Claude Code official best practices. Auto-invocable. Optional argument: skill name.
---
